...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/proyecto2estructuradatos.exe
...
${OBJECTDIR}/ListaLocalidadGeneral.o: ListaLocalidadGeneral.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListaLocalidadGeneral.o ListaLocalidadGeneral.cpp
...
${OBJECTDIR}/NodoListaSimple.o: NodoListaSimple.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NodoListaSimple.o NodoListaSimple.cpp

${OBJECTDIR}/NodoMatriz.o: NodoMatriz.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NodoMatriz.o NodoMatriz.cpp
...
${OBJECTDIR}/PilaAreaPreferencial.o: PilaAreaPreferencial.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PilaAreaPreferencial.o PilaAreaPreferencial.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/proyecto2estructuradatos.exe
